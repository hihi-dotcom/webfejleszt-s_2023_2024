...
for(const kerdes of tomb){
    const kerdesek = new Question(kerdes.question, kerdes.answers, kerdes.rightAnswer);

    kerdes_tomb.push(kerdesek);
}
const manager = new Manager(kerdes_tomb);

const kerdesresz = new QuestionArea('question');
const answerresz = new AnswerArea('answers');
